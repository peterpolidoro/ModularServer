...
dev.set_serial_number('?')
{'name': 'setSerialNumber', 'parameters': ['serial_number'], 'return': None}
dev.set_serial_number('??')
{'name': 'setSerialNumber',
