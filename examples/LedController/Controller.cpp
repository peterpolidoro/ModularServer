...
void Controller::setup()
{
  ...
  // Parameters
  ModularDevice::Parameter& duration_on_parameter = modular_server.createParameter(constants::duration_on_parameter_name);
  ...
  ModularDevice::Parameter& duration_off_parameter = modular_server.copyParameter(duration_on_parameter,constants::duration_off_parameter_name);
  ModularDevice::Parameter& count_parameter = modular_server.createParameter(constants::count_parameter_name);
  count_parameter.setRange(constants::count_min,constants::count_max);

  // Methods
  ModularDevice::Method& led_on_method = modular_server.createMethod(constants::led_on_method_name);
  led_on_method.attachCallback(callbacks::setLedOnCallback);

  ModularDevice::Method& led_off_method = modular_server.createMethod(constants::led_off_method_name);
  led_off_method.attachCallback(callbacks::setLedOffCallback);

  ModularDevice::Method& get_led_pin_method = modular_server.createMethod(constants::get_led_pin_method_name);
  get_led_pin_method.attachCallback(callbacks::getLedPinCallback);
  get_led_pin_method.setReturnTypeLong();

  ModularDevice::Method& blink_led_method = modular_server.createMethod(constants::blink_led_method_name);
