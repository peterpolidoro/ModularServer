...
const Modular::SubsetMemberType odd_subset[ODD_SUBSET_LENGTH] =
  {
    {.l=1},
    {.l=3},
    {.l=5},
...
const Modular::SubsetMemberType mode_ptr_subset[MODE_SUBSET_LENGTH] =
  {
    {.cs_ptr=&mode_rising},
    {.cs_ptr=&mode_falling},
    {.cs_ptr=&mode_change},
...
const Modular::SubsetMemberType count_subset[COUNT_SUBSET_LENGTH] =
  {
    {.l=10},
    {.l=20},
    {.l=30},
...
const Modular::SubsetMemberType direction_ptr_subset[DIRECTION_SUBSET_LENGTH] =
  {
    {.cs_ptr=&direction_up},
