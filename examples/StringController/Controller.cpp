...
void Controller::setup()
{
  ...
  // Parameters
  ModularDevice::Parameter& string_parameter = modular_server.createParameter(constants::string_parameter_name);
  string_parameter.setTypeString();
  ModularDevice::Parameter& string2_parameter = modular_server.copyParameter(string_parameter,constants::string2_parameter_name);
  ModularDevice::Parameter& count_parameter = modular_server.createParameter(constants::count_parameter_name);
  count_parameter.setRange(constants::count_min,constants::count_max);
  ModularDevice::Parameter& index_array_parameter = modular_server.createParameter(constants::index_array_parameter_name);
  ...
  ModularDevice::Parameter& starting_chars_count_parameter = modular_server.createParameter(constants::starting_chars_count_name);
  starting_chars_count_parameter.setRange(constants::starting_chars_count_min,constants::starting_chars_count_max);
  ModularDevice::Parameter& double_echo_parameter = modular_server.createParameter(constants::double_echo_parameter_name);
  double_echo_parameter.setTypeBool();

  // Methods
  ModularDevice::Method& echo_method = modular_server.createMethod(constants::echo_method_name);
  ...
  ModularDevice::Method& length_method = modular_server.createMethod(constants::length_method_name);
  ...
  ModularDevice::Method& starts_with_method = modular_server.createMethod(constants::starts_with_method_name);
  ...
  ModularDevice::Method& repeat_method = modular_server.createMethod(constants::repeat_method_name);
  ...
  ModularDevice::Method& chars_at_method = modular_server.createMethod(constants::chars_at_method_name);
  ...
  ModularDevice::Method& starting_chars_method = modular_server.createMethod(constants::starting_chars_method_name);
  ...
  ModularDevice::Method& set_starting_chars_count_method = modular_server.createMethod(constants::set_starting_chars_count_method_name);
  ...
  ModularDevice::Method& get_starting_chars_count_method = modular_server.createMethod(constants::get_starting_chars_count_method_name);
  ...
  ModularDevice::Method& set_stored_string_method = modular_server.createMethod(constants::set_stored_string_method_name);
  ...
  ModularDevice::Method& get_stored_string_method = modular_server.createMethod(constants::get_stored_string_method_name);
