...
extern ConstantString test_bool_field_name;
extern const bool test_bool_default;

extern ConstantString test_long_array_field_name;
enum{TEST_LONG_ARRAY_LENGTH=4};
extern const long test_long_array_default[TEST_LONG_ARRAY_LENGTH];
...
extern ConstantString test_bool_method_name;
extern ConstantString test_long_array_method_name;
extern ConstantString test_long_array_variable_method_name;
